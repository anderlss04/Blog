    ...
    <div class="row g-0 d-flex">
        ...
        <div class="col-md-12">
            ...
            <div class="card-footer d-flex justify-content-between">
               ...
               <button id="botonComments" href="?title=<?php echo $post['title'] ?>" type="button" class="btn btn-primary" data-bs-toggle="modal"
...
<script>
    $(document).ready(function () {
        $('#botonComments').click(function () {
            var title = $(this).attr("href");
            $.ajax({
                url: "Controller/ver/C_Ver_Posts.php",
                method: "POST",
                data: {
                    title: title
                },
                success: function (data) {
                    $('#ComentModal').html(data);
