...
<div class="d-flex flex-direccion-row w-100 h-100 ">
    <div id="container-main" class="d-flex flex-direccion-row  p-5 ">
        <div id="content-main" class="content  col-xl-12 d-flex justify-content-center overflow-hidden  h-100 ">
            <div id="publicacion" class=" col-xl-12  w-75 overflow-auto">

            <?php foreach ($posts as $post) { var_dump($post['title']) ?>
