...
<form action="<?php echo $var[0]['ruta'] ?> " method="POST" class="text-center">
    ...
    <div class="row">
        <div class="col-md-4 mb-4">
            <div class="form-outline">
                <input value="<?php echo $username; ?>" type="text" id="formUserName" name="username" class="form-control" />
    ...
    <div class="form-outline mb-4">
        <input value="<?php echo $first_name; ?>" type="password" id="formPass" name="password" class="form-control" />
