                    ...
                    <div class="datos-perfil ">
                        ...
                        <form action="<?php echo $var[0]['ruta'] ?> " method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input value="<?php echo $first_name;?>" id="namae" name="namae" placeholder="nombre de Usuario" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="lastname">Apellido</label>
                                <input value="<?php echo $first_name;?>" id="lastname" name="lastname" placeholder="nombre de Usuario" type="text" class="form-control">
                            </div>
