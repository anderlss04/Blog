...
class M_Usuario extends Conexion{
    ...
    public function modUsuario(Usuario $usuario){
        ...
        $sentencia->bind_param("sssssssss", $usuario->getEmail(), $usuario->getCreated_on(), $usuario->getLast_login(), $usuario->getActive(), $usuario->getFirst_name(), $usuario->getLast_name(), $usuario->getRol(), $usuario->getUsername());
